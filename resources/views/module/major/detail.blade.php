        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-6 flex flex-col">
                ...
                <x-text-input id="major_name" name="name" placeholder="Program Studi" type="text"
                    class="mt-1 block w-full" value="{{ $major->name }}" required autofocus />
            ...
            <div class="col-span-3 flex flex-col">
                ...
                <x-text-input id="major_code" name="code" placeholder="Kode Huruf" type="text"
                    class="mt-1 block w-full" value="{{ $major->code }}" required autofocus />
            ...
            <div class="col-span-3 flex flex-col">
                ...
                <x-text-input id="major_code_number" name="code_number" placeholder="Kode Angka" type="text"
                    class="mt-1 block w-full" value="{{ $major->code_number }}" required autofocus />
            ...
            <div class="col-span-12 flex flex-col">
                ...
                <x-textarea id="description" name="description" placeholder="Deskripsi Program Studi"
                    class="mt-1 block w-full" required autofocus>{{ $major->description }}</x-textarea>
                <x-input-error :messages="$errors->get('description')" class="mt-2" />
            </div>
        </div>
        <x-slot name="footer">
            <div class="flex justify-end gap-2">
                <x-secondary-button onclick="window.location.href = ('{{ route('major.index') }}')">
                    {{ __('Kembali') }}
                </x-secondary-button>
