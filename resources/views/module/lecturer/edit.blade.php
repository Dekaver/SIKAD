            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-6 flex flex-col">
                    ...
                    <select name="user_id"
                        ...
                        @foreach ($users as $user)
                            <option value="{{ $user->id }}" @selected($lecturer->user_id == $user->id)>
                                {{ $user->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-span-6 flex flex-col">
                    ...
                    <select name="major_id"
                        ...
                        @foreach ($majors as $major)
                            <option value="{{ $major->id }}" @selected($lecturer->major_id == $major->id)>
                                {{ $major->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-span-3 flex flex-col">
                    ...
                    <x-text-input id="nidn" name="nidn" placeholder="NIDN" type="text"
                        class="mt-1 block w-full" value="{{ $lecturer->nidn }}" required autofocus />
                ...
                <div class="col-span-3 flex flex-col">
                    ...
                    <select name="gender"
                        ...
                        <option value="laki_laki" @selected($lecturer->gender == 'laki_laki')>{{ __('Laki-laki') }}</option>
                        <option value="perempuan" @selected($lecturer->gender == 'perempuan')>{{ __('Perempuan') }}</option>
                    </select>
                ...
                <div class="col-span-3 flex flex-col">
                    ...
                    <x-text-input id="place_of_birth" name="place_of_birth" placeholder="{{ __('Tempat Lahir') }}"
                        type="text" class="mt-1 block w-full" value="{{ $lecturer->place_of_birth }}" required
                        autofocus />
                ...
                <div class="col-span-3 flex flex-col">
                    ...
                    <x-text-input id="birth_date" name="birth_date" placeholder="{{ __('Tanggal Lahir') }}"
                        type="date" class="mt-1 block w-full" value="{{ $lecturer->birth_date?->format('Y-m-d') }}"
                        required autofocus />
